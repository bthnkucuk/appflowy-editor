...
typedef MobileToolbarItemIconBuilder = Widget? Function(BuildContext context, EditorState editorState);

/// Fired when the user taps the toolbar item's icon.
typedef MobileToolbarItemActionHandler = void Function(BuildContext context, EditorState editorState);
...
typedef MobileToolbarSheetBodyBuilder = Widget Function(BuildContext context, EditorState editorState, Selection selection);
...
class MobileToolbarItem {
  const MobileToolbarItem({required this.itemIconBuilder, required this.actionHandler});
      ...
      actionHandler: (context, editorState) {
        ...
        Navigator.of(context)
              ...
              StupidSimpleSheetRoute<void>(
                ...
                child: MobileToolbarTheme(
                  child: EditorToolbarSheetScaffold(
                    child: Builder(builder: (sheetContext) => sheetBodyBuilder(sheetContext, editorState, selection)),
                  ),
                ),
              ),
            )
            .then((_) {
              ...
              editorState.updateSelectionWithReason(selection, extraInfo: {selectionExtraInfoDisableFloatingToolbar: true});
